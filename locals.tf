locals {
  ...
  regex_validate_mgmt_image_name = "check-point-r8[0-2][1-4]0-(byol|payg)-[0-9]{3}-([0-9]{3,}|[a-z]+)-v[0-9]{8,}"
  regex_validate_single_image_name = "check-point-r8[0-2][1-4]0-gw-(byol|payg)-single-[0-9]{3}-([0-9]{3,}|[a-z]+)-v[0-9]{8,}"
